...
<html>
  ...
  <form action="NewsAction!addNews" id="form_add" method="post">
	  <fieldset>
	  	<div>新闻标题：<input name="news.title" placeHolder="新闻标题" value=""/></div>
	  	
	  	<div>新闻来源：<input name="news.source" placeHolder="新闻来源" value=""/></div>
	  	...
	  	<div>新闻内容：<!-- <input id="news_content" name="news.content" placeHolder="新闻内容"/> -->
		  	<div class="container">
			<div class="hero-unit">
				<h1>
					Bootstrap富文本编辑器 <br> 
	  	...
	  	<input type="button" value="添加新闻" onclick="dosubmit()">
	  </fieldset>
  </form>
  <script>
