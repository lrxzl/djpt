...
<html>
  <head>
	...
	-->
	<script src="admin/js/esl.js"></script>  
  ...
  <script type="text/javascript">
		...
		var ZhengShi=0;var ZhengShi_man=0;var ZhengShi_woman=0;var ZhengShi_zhuan=0;var ZhengShi_ben=0;		
		 $.ajax({  
       	...
       	var Totalman=[TuanYuan_man,JijiFenzi_man,YuBei_man,ZhengShi_man];
        var Totalwoman=[TuanYuan_woman,JijiFenzi_woman,YuBei_woman,ZhengShi_woman];
...
　　　　					formatter: "{a0} : {c0}",/* 模板变量有 {a}, {b}，{c}，{d}，{e}，分别表示系列名，数据名，数据值等 */
			　			axisPointer : {type : 'line',
										lineStyle:{color:'rgba(128, 128, 128, 0.8)',type:'dashed',}
...
　　pieChart.setOption(optionpie1);
  ...
  <body>
  <div> 
	<div id="bar" style="height:400px;width: 800px;float:left;margin:20px;"></div>
	<div id="pie" style="height:400px;width: 600px;float:left;margin:20px;"></div>
</div>
<div>
	<div id="bar1" style="height:400px;width: 800px;float:left;margin:20px;"></div>
	<div id="pie1" style="height:400px;width: 600px;float:left;margin:20px;"></div>
</div>	

<!-- //后期加timeline,以时间段查看增加或减少现象 -->
  </body>
</html>
