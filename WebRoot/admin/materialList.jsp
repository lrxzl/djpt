...
<html>
  ...
  <body>
		  ...
		  <div class="col-md-2">
			<div class="sidebar content-box" style="display: block;">
			     <ul class="nav">
			         ...
			         <li class="submenu current open">
			              ...
			              <!-- Sub menu -->
		                  <ul>
		                      <li class="current"><a href="AdminAction!loadUnderReviews">待审核</a></li>
		   ...
		   <div class="content-box-large">
  				<div class="panel-heading">
					<div class="panel-title">审核列表</div>
				</div>
  				<div class="panel-body">
  					<label>
  					材料类型
  					<select id="m_type" name="type"></select>
  					</label>
    ...
    <script>
    	...
    	init();
    	function init() {
    		var mtype = document.getElementById('m_type');
    		
    		for(var i=0;i<m_cn.length;i++) {
    			var opt = document.createElement("option");
    			opt.setAttribute("class", "mtype");
    			opt.setAttribute("value",m_cn[i]);
    			opt.innerText = m_cn[i];
    			mtype.appendChild(opt);
    		}
    		
    		$('#m_type').change(function() {
    			$('#example_filter').find('input').val($(this).val());
    		});
